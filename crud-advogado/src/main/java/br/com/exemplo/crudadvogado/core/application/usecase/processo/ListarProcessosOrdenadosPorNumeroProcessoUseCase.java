...
public class ListarProcessosOrdenadosPorNumeroProcessoUseCase {

    private final ProcessoGateway processoGateway;

    public ListarProcessosOrdenadosPorNumeroProcessoUseCase(ProcessoGateway processoGateway) {
        this.processoGateway = processoGateway;
    }

    public List<ProcessoResponse> executar(UUID idAdvogado) {
        List<Processo> processos = processoGateway.listarProcessosOrdenadosPorNumeroProcesso(idAdvogado);
