...
public class ListarClientesOrdenadosPorProcessosUseCase {

    private final ClienteGateway clienteGateway;
    private final AdvogadoGateway advogadoGateway;
    private final ProcessoGateway processoGateway;

    public ListarClientesOrdenadosPorProcessosUseCase(ClienteGateway clienteGateway, AdvogadoGateway advogadoGateway, ProcessoGateway processoGateway) {
