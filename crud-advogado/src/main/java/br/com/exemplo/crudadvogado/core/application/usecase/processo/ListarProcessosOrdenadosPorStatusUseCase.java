...
public class ListarProcessosOrdenadosPorStatusUseCase {
    private final ProcessoGateway processoGateway;

    public ListarProcessosOrdenadosPorStatusUseCase(ProcessoGateway processoGateway) {
        this.processoGateway = processoGateway;
    }

    public List<ProcessoResponse> executar(UUID idAdvogado) {
        List<Processo> processos = processoGateway.listarProcessosOrdenadosPorStatus(idAdvogado);
