...
public class ListarProcessosOrdenadosPorValorUseCase {
    private final ProcessoGateway processoGateway;

    public ListarProcessosOrdenadosPorValorUseCase(ProcessoGateway processoGateway) {
        this.processoGateway = processoGateway;
    }

    public List<ProcessoResponse> executar(UUID idAdvogado) {
        List<Processo> processos = processoGateway.listarProcessosOrdenadosPorValor(idAdvogado);
