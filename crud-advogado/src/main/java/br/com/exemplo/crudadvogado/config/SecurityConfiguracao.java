package br.com.exemplo.crudadvogado.config;
...
public class SecurityConfiguracao {
    ...
    private static final AntPathRequestMatcher[] URLS_PERMITIDAS = {
            ...
            new AntPathRequestMatcher("/api/advogados/login/**"),
            new AntPathRequestMatcher("/api/advogados/cadastrar/**"),
            new AntPathRequestMatcher("/api/solicitacao-agendamento/solicitar/**"),
