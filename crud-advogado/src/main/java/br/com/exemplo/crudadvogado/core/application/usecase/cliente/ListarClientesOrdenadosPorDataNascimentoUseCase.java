...
public class ListarClientesOrdenadosPorDataNascimentoUseCase {
    private final ClienteGateway clienteGateway;
    private final AdvogadoGateway advogadoGateway;
    private final ProcessoGateway processoGateway;

    public ListarClientesOrdenadosPorDataNascimentoUseCase(ClienteGateway clienteGateway, AdvogadoGateway advogadoGateway, ProcessoGateway processoGateway) {
