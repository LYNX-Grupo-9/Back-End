...
class ListarProcessosOrdenadosPorNumeroProcessoUseCaseTest {

    private ProcessoGateway processoGateway;
    private ListarProcessosOrdenadosPorNumeroProcessoUseCase useCase;

    @BeforeEach
    void setUp() {
        processoGateway = mock(ProcessoGateway.class);
        useCase = new ListarProcessosOrdenadosPorNumeroProcessoUseCase(processoGateway);
    }
    ...
    void deveRetornarListaDeProcessosQuandoExistirem() {
        ...
        when(processoGateway.listarProcessosOrdenadosPorNumeroProcesso(idAdvogado))
        ...
        verify(processoGateway, times(1)).listarProcessosOrdenadosPorNumeroProcesso(idAdvogado);
    }
