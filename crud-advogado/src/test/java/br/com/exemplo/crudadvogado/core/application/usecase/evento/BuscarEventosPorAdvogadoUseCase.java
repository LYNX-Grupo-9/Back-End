...
class BuscarEventosPorAdvogadoUseCaseTest {

    @Mock
    private EventoGateway eventoGateway;

    @InjectMocks
    private BuscarEventosPorAdvogadoUseCase useCase;
    ...
    // ============================================
    @Test
    void deveBuscarEventosPorAdvogadoComSucesso() {

        Evento evento1 = mock(Evento.class);
        Evento evento2 = mock(Evento.class);

        when(eventoGateway.buscarPorAdvogado(idAdvogado))
    ...
    // ============================================
    @Test
    void deveRetornarListaVaziaQuandoNaoHouverEventos() {
