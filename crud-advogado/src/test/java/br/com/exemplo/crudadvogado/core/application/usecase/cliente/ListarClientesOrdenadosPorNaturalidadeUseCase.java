...
class ListarClientesOrdenadosPorNaturalidadeUseCaseTest {
    ...
    @InjectMocks
    private ListarClientesOrdenadosPorNaturalidadeUseCase listarClientesUseCase;
    ...
    // ==================================================
    // ✅ SUCESSO — LISTAGEM E ORDENAÇÃO POR QTD PROCESSOS
    // ==================================================
    @Test
    void deveListarClientesOrdenadosPorQuantidadeDeProcessos() {
        ...
        List<ClienteResponse> response =
                listarClientesUseCase.executar(idAdvogado);

        // ASSERT
        assertNotNull(response);
        assertEquals(2, response.size());

        // cliente2 deve vir primeiro (4 processos)
