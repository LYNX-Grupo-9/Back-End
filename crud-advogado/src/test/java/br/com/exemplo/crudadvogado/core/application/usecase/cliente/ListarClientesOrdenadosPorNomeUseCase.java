...
class ListarClientesOrdenadosPorNomeUseCaseTest {
    ...
    @InjectMocks
    private ListarClientesOrdenadosPorNomeUseCase listarClientesUseCase;
    ...
    void deveListarClientesOrdenadosPorQuantidadeDeProcessos() {
        ...
        // cliente2 deve vir primeiro (6 processos)
