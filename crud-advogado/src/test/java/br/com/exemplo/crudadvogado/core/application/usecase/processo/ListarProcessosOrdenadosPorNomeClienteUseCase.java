...
class ListarProcessosOrdenadosPorNomeClienteUseCaseTest {

    private ProcessoGateway processoGateway;
    private ListarProcessosOrdenadosPorNomeClienteUseCase useCase;

    @BeforeEach
    void setUp() {
        processoGateway = mock(ProcessoGateway.class);
        useCase = new ListarProcessosOrdenadosPorNomeClienteUseCase(processoGateway);
    }
    ...
    void deveRetornarListaDeProcessosQuandoExistirem() {
        ...
        when(processoGateway.listarProcessosOrdenadosPorNomeCliente(idAdvogado))
        ...
        verify(processoGateway, times(1)).listarProcessosOrdenadosPorNomeCliente(idAdvogado);
    }
