...
class ListarProcessosOrdenadosPorValorUseCaseTest {

    private ProcessoGateway processoGateway;
    private ListarProcessosOrdenadosPorValorUseCase useCase;

    @BeforeEach
    void setUp() {
        processoGateway = mock(ProcessoGateway.class);
        useCase = new ListarProcessosOrdenadosPorValorUseCase(processoGateway);
    }
    ...
    void deveRetornarListaDeProcessosQuandoExistirem() {
        ...
        when(processoGateway.listarProcessosOrdenadosPorValor(idAdvogado))
        ...
        verify(processoGateway, times(1)).listarProcessosOrdenadosPorValor(idAdvogado);
    }
